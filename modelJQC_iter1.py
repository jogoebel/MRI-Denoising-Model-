...
class WGAN():   
    def __init__(self, levels, modalities, version, checkpoint_path=None):
        ...
        self.d_iter = 1                 # Number of discriminator iterations per generator iteration
        ...
        print(f"Training Notes: Changed to number the discriminator trains per generator to 1")
