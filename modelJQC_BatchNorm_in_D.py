...
class WGAN():   
    def __init__(self, levels, modalities, version, checkpoint_path=None):
        ...
        self.d_iter = 5                  # Number of discriminator iterations per generator iteration
        ...
        print(f"Training Notes: enabled batch normalization for the discirminator")
...
if __name__ == "__main__":
    ...
    version = "27Nov_batchnorm_disc"
    #checkpoint = "/nas/longleaf/home/janeqiu/Desktop/BMME 575/Project/MRI-Denoising-Project/15Nov_MXv3_Rem4096v1/checkpoints/20241115_202421/e1_lr5e-05_20241115_204044.pth"
